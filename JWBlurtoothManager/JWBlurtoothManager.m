...
@implementation JWBlurtoothManager


+(JWBlurtoothManager*)shareInstance
{
    static dispatch_once_t pred = 0;
    __strong static JWBlurtoothManager *_sharedObject = nil;
    dispatch_once(&pred, ^{
...
//        _cbServices =[[CBService alloc] ini];
